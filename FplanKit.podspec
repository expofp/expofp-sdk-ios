#
#  Be sure to run `pod spec lint FplanKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Vladimir" => "vladimir@expofp.com" }
  # Or just: spec.author    = "Vladimir"
  # spec.authors            = { "Vladimir" => "vladimir@expofp.com" }
  # spec.social_media_url   = "https://twitter.com/Vladimir"
